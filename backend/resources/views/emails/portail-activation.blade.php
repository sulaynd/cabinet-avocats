...
<body style="font-family: Georgia, serif; color:#1B2430; max-width:520px; margin:0 auto; padding:24px;">
    ...
    <p>Un espace personnel vous a été ouvert pour suivre l'avancement de vos dossiers,
        consulter vos factures et accéder à vos documents en ligne.</p>
    ...
    <table style="background:#F7F5EF; border-radius:4px; padding:16px 20px; margin:20px 0; width:100%; border-collapse:collapse;">
        ...
        <tr>
            <td style="padding:0 0 12px; font-weight:bold;">{{ $client->email }}</td>
        </tr>
        <tr>
    ...
    <p style="font-size:13px; color:#555;">
        ...
        Si vous n'êtes pas à l'origine de cette demande, contactez-nous directement.
    </p>
