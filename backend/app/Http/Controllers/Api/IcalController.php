...
class IcalController extends Controller
{
    ...
    public function personnel(string $token)
    {
        ...
        $ics = $this->construireIcs("Agenda de {$utilisateur->name} — JCA", $echeances);
    ...
    public function equipe(string $token)
    {
        ...
        $ics = $this->construireIcs('Agenda collectif — JCA', $echeances);
    ...
    private function construireIcs(string $nomCalendrier, Collection $echeances): string
    {
        ...
        foreach ($echeances as $echeance) {
            ...
            $lignes[] = 'BEGIN:VEVENT';
            $lignes[] = 'UID:echeance-' . $echeance->id . '@jca.ca';
