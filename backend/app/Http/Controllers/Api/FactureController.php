...
class FactureController extends Controller
{
    ...
    public function update(Request $request, Facture $facture)
    {
        ...
        $data = $request->validate([
            ...
            'taux_tps' => 'numeric|min:0|max:100',
    ...
    {
        $annee = now()->year;
        // MAX du suffixe numérique, pas count() : voir le commentaire équivalent
        // dans FacturationAutomatique::genererNumero() pour l'explication complète.
