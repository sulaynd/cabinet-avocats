...
class ReinitialiserMotDePasseCollaborateurMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $lien = "{$urlFrontend}/collaborateur/reinitialiser-mot-de-passe?email=" . urlencode($this->email) . "&token={$this->token}";
