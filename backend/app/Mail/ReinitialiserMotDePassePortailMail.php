...
class ReinitialiserMotDePassePortailMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $lien = "{$urlFrontend}/portail/reinitialiser-mot-de-passe?email=" . urlencode($this->email) . "&token={$this->token}";
