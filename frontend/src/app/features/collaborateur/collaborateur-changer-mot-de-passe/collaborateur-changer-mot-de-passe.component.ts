...
@Component({
  selector: 'app-collaborateur-changer-mot-de-passe',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatButtonModule],
  templateUrl: './collaborateur-changer-mot-de-passe.component.html',
})
export class CollaborateurChangerMotDePasseComponent {
  chargement = false;
  erreur = '';
  ...
  constructor(private collaborateurAuth: CollaborateurAuthService, private router: Router) {}
  ...
  soumettre(): void {
    ...
    this.collaborateurAuth.changerMotDePasse(this.form.value.password!).subscribe({
      next: () => {
